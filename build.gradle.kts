...
subprojects {
    ...
    dependencies {
        compileOnly("com.viaversion:viaversion:5.4.1-1.21.7-rc1-SNAPSHOT")
        compileOnly("com.viaversion:viabackwards:5.4.1-1.21.7-rc1-SNAPSHOT")
    }
...
base {
    archivesName.set("ViaAprilFools")
}
