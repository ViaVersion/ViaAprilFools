...
public enum EntityTypes26w14a implements EntityType {
    ...
    INTERACTION(ENTITY),
    LIVING_BLOCK(ENTITY),
    LIVING_BLOCK_COMMAND(ENTITY),
    CRAFTING_GRID(ENTITY),
    HOVERING_ITEM(ENTITY),
    ...
    ABSTRACT_NAUTILUS(TAMABLE_ANIMAL, null),
    NAUTILUS(ABSTRACT_NAUTILUS),
    ZOMBIE_NAUTILUS(ABSTRACT_NAUTILUS),
    ...
    EntityTypes26w14a(final EntityType parent) {
        this.parent = parent;
        this.identifier = Key.namespaced(name().toLowerCase(Locale.ROOT));
    }

    EntityTypes26w14a(final EntityType parent, final String identifier) {
        this.parent = parent;
